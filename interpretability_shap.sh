...
singularity exec --nv deoxys.sif python interpretability_shap.py $PROJECTS/ngoc/CoxaAI/perf/pretrain/$1 --temp_folder $SCRATCH_PROJECTS/ngoc/CoxaAI/perf/$1 --analysis_folder $SCRATCH_PROJECTS/ngoc/CoxaAI/perf/$1 ${@:2}