...
singularity exec --nv deoxys_2024.sif python experiment_multiclass_coral_transfer_v2_run_test.py $1 $PROJECTS/ngoc/CoxaAI/perf/transfer_v2/$2 --temp_folder $SCRATCH_PROJECTS/ceheads/CoxaAI/transfer_v2/$2 --epochs $3 ${@:4}
