...
singularity exec --nv deoxys_2024.sif python experiment_multiclass_transfer.py $1 $PROJECTS/ngoc/CoxaAI/perf/transfer/$2 --temp_folder $SCRATCH_PROJECTS/ceheads/CoxaAI/transfer/$2 --epochs $3 ${@:4}
