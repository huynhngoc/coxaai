...
singularity exec --nv deoxys.sif python experiment_binary.py $1 $PROJECTS/ngoc/CubiAI/perf/scratch/$2 --temp_folder $SCRATCH_PROJECTS/ceheads/CubiAI/scratch/$2 --epochs $3 ${@:4}
