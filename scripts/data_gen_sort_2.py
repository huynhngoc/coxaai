...
# df.to_csv(base_path + 'csv_train_info/Feb2024.csv', index_label='pid')


df = pd.read_csv(base_path + 'csv_train_info/Feb2024.csv')
...
# df.to_csv(base_path + 'csv_train_info/Feb2024_split.csv', index=False)

df = pd.read_csv(base_path + 'csv_train_info/Feb2024_split.csv')


h5_filename = 'P:/CoxaAI/datasets/hips_800_sort_2.h5'
resize_shape = 800
